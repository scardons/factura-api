...
Object.defineProperty(exports, "cargarTokens", { enumerable: true, get: function () { return tokenStore_1.cargarTokens; } });
...
function obtenerTokensQuickBooks(code, realmId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield (0, tokenStore_1.setTokens)(access_token, refresh_token, realmId, expires_in);
        return response.data;
    });
}
function refrescarTokenQuickBooks() {
    return __awaiter(this, void 0, void 0, function* () {
        const refreshToken = yield (0, tokenStore_1.getRefreshToken)();
        if (!refreshToken) {
            console.error('❌ No refresh token disponible');
            throw new Error('No refresh token disponible');
        }
        const tokens = yield (0, tokenStore_1.cargarTokens)();
...
function getAccessTokenSeguro() {
    return __awaiter(this, void 0, void 0, function* () {
        const tokenExpiry = yield (0, tokenStore_1.getTokenExpiry)();
        ...
        const tokens = yield (0, tokenStore_1.cargarTokens)();
        const accessToken = (tokens === null || tokens === void 0 ? void 0 : tokens.access_token) || null;
